...
//console.log(title,cost,count,department);
...
// cost[1].value=Math.ceil(taxValue);
let getTotalValue=(+price + (+price * (+tax) /100) + (+Tcost) )-(+price * (+discound) /100);
cost[4].value=Math.ceil(getTotalValue);
}
